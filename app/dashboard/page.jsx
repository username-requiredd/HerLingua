      ...
      <header className="bg-blue-600 text-white shadow-md">
        <div className="container mx-auto px-4 py-4 flex justify-between items-center">
          ...
          <div className="flex items-center space-x-4">
            ...
            <Link href="/login" className="px-3 py-1 bg-blue-700 rounded hover:bg-blue-800">
              Logout
            </Link>
          </div>
        </div>
            ...
            <div className="bg-white p-6 rounded-lg shadow-md">
              ...
              <nav>
                <ul className="space-y-2">
                  <li>
                    <Link href="/dashboard" className="block px-3 py-2 bg-blue-100 rounded text-blue-700">
                      Course Dashboard
                    </Link>
                  </li>
                  <li>
                    <Link href="#" className="block px-3 py-2 hover:bg-gray-100 rounded">
                      My Profile
                    </Link>
                  </li>
                  <li>
          ...
          <div className="md:col-span-3">
            ...
            <div className="bg-white p-6 rounded-lg shadow-md mb-6">
              ...
              <div className="border-l-4 border-blue-500 pl-4">
                ...
                <p className="text-lg font-semibold">Lesson 9: Articles (der, die, das)</p>
                <div className="mt-3">
                  <Link href="/lessons/9" className="px-4 py-2 bg-blue-600 text-white rounded hover:bg-blue-700">
                    Continue Lesson
                  </Link>
                </div>
              </div>
