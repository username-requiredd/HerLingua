...
export default function Home() {
  ...
  const courseLevels = {
    ...
    a2: {
      title: "Elementary (A2)",
      description:
        "Build confidence with common phrases and simple conversations.",
      duration: "10 weeks",
      modules: 5,
      features: [
        "Shopping dialogues",
    ...
    b1: {
      ...
      description:
        "Handle travel situations and express opinions on familiar topics.",
      duration: "12 weeks",
      modules: 6,
      features: [
        "Past/future tenses",
    ...
    b2: {
      ...
      description:
        "Discuss abstract ideas and interact with native speakers comfortably.",
      duration: "14 weeks",
      modules: 7,
      features: [
    ...
    c1: {
      title: "Advanced (C1)",
      description:
        "Express yourself fluently in professional and academic settings.",
      duration: "16 weeks",
      modules: 8,
      features: [
        "Academic writing",
    ...
    c2: {
      ...
      description:
        "Master German at near-native level with cultural subtleties.",
      duration: "18 weeks",
      modules: 9,
      features: [
        "Legal/medical German",
        "Regional dialects",
        "Translation skills",
        "Public speaking",
      ],
