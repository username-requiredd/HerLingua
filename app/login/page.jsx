...
export function SignIn({ onClose, setOnSwitchToSignUp,setShowModal }) {
  ...
  return (
    <div className={`fixed inset-0 bg-black/50 backdrop-blur-sm z-50 flex items-center justify-center p-4 ${onClose? "block":"hidden"}`}>
      <motion.div 
        ...
        <div className="p-6">
          ...
          <form className="space-y-4">
            ...
            <div className="flex justify-end">
              <button type="button" className="text-sm text-pink-600 hover:underline">Forgot password?</button>
            </div>
