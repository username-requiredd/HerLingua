        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div className="md:col-span-1">
            <div className="flex items-center mb-4">
              <div className="w-10 h-10 rounded-full bg-pink-400 flex items-center justify-center text-white font-bold text-xl">
                H
              </div>
              <span className="ml-2 font-bold text-xl">HerLingua</span>
            </div>
            <p className="text-pink-100 mb-4">
              Master German naturally with our immersive courses designed for
              all levels.
            </p>
          ...
          <div>
            <h3 className="text-lg font-semibold mb-4 border-b border-pink-400 pb-2">
              Quick Links
            </h3>
            <ul className="space-y-2">
              {["Home", "Courses", "Pricing", "About Us", "Contact"].map(
                (link) => (
                  <li key={link}>
                    <a
                      href="#"
          ...
          <div>
            ...
            <div className="mt-6">
              <h4 className="text-sm font-semibold mb-2 text-pink-200">
                NEWSLETTER SIGNUP
              </h4>
              <div className="flex">
                <input
